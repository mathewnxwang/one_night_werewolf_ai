...
def _get_random_player(players, player_id: str) -> str:
    '''
...
def _switch_player_roles(players: Dict[str, Dict[str, Any]], player_1_name: str, player_2_name: str) -> Dict[str, Dict[str, Any]]:
    '''
...
def execute_seer_action(players: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    target_player_name = _get_random_player(players, seer_player_name)
...
def execute_robber_action(players: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    target_player_name = _get_random_player(players, robber_player_name)
    original_target_role = players[target_player_name]['true_role']

    players = _switch_player_roles(players, robber_player_name, target_player_name)
...
def execute_troublemaker_action(players: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    players = _switch_player_roles(players, player_1_name, player_2_name)
